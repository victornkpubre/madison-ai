...
from graph import build_graph as build_reply_graph
...
class MainState(MessagesState):
    ...
    # ── assist_agent (assistant_graph.py) ─────────────────────────────────
    ...
    # idea_agent (idea_graph.py) uses only messages — no extra fields needed
